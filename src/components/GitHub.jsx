        ...
        <div className="flex flex-col gap-4 md:w-4/6 lg:pr-36">
            <div className="flex flex-col gap-1">
                ...
                <p className="text-cyan-100 text-sm">
                    My GitHub commit history shows how determined I am to
                    continue learning and building. Ever since I graduated my
                    Bootcamp in November 2022, I have been building projects and
                    self learning through Udemy and Youtube courses, as well as
