...
const SideProjects = () => {
  ...
  return (
    <ul className="flex flex-col md:flex-row md:flex-wrap md:justify-around lg:w-full lg:flex-col lg:pt-48 lg:flex-nowrap  gap-2 pr-5 h-[170px] lg:h-[500px] lg:mr-10 overflow-y-auto scrollbar-thin scrollbar-thumb-green-400 scrollbar-track-zinc-50 scrollbar-thumb-rounded scrollbar-track-rounded">
